...
namespace Lesson06_EFCore_CodeFIrst.Controllers
{
    public class BooksController : Controller
    {
        private readonly BusinessDBContext _context;

        public BooksController(BusinessDBContext context)
        {
            _context = context;
        }
        ...
        {
            var businessDBContext = _context.Books.Include(b => b.Category).Include(b => b.Publisher);
