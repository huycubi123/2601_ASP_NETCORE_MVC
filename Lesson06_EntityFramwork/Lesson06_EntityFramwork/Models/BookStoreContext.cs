...
namespace Lesson06_EntityFramwork.Models;
...
//        => optionsBuilder.UseSqlServer("Server=DESKTOP-77N60BN\\SQLEXPRESS;Database=BookStore;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A63B3C4CA7");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C207788FBB49");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B21BDBD6C");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCFEF6FEEC3");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C5E3CD05C");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FAB07283296");
